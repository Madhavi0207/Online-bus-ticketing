...
const ServicesPage = () => {
  ...
  return (
    <div className="section-container p-20 bg-gray-200">
      ...
      {/* Main Services */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-16 text-center ">
        {services.map((service) => (
          <div
            key={service._id}
            className="card hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border-2 border-white rounded-md p-4 bg-white"
          >
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto ">
          <div className="relative border-4 border-white border-primary-500 rounded-md p-6">
          ...
          <div className="relative  border-4 border-white border-primary-500 rounded-lg p-15">
            <div className="absolute -top-4 -left-4 w-8 h-8 bg-primary-600 text-black rounded-full flex items-center justify-center font-bold">
              2
            </div>
            <div className="card pt-8">
